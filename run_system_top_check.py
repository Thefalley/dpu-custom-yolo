#!/usr/bin/env python3
"""
Run dpu_system_top AXI4-Lite testbench:
...
def main():
    print("=" * 60)
    print("  DPU System Top — AXI4-Lite Integration Test")
    print("=" * 60)
    ...
    srcs = [
        ...
        tb_dir / "dpu_system_top_tb.sv",
    ]

    vvp_file = PROJECT_ROOT / "sim_system_top.vvp"
    ...
    if "ALL TESTS PASSED" in r.stdout:
        print("\n*** SYSTEM TOP TEST: PASS ***")
        return 0
    else:
        print("\n*** SYSTEM TOP TEST: CHECK OUTPUT ***")
        return 1
